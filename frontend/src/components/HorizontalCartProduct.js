...
const HorizontalCartProduct = ({ category,heading }) => {
    ...
    return (
      <div className="container mx-auto px-8 my-6 relative">
        ...
        <div
          className="flex items-center gap-2 md:gap-6 overflow-scroll scroll-none transition-all"
          ref={scrollElement}
        >
          <button
                ...
                return (
                  <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex ">
                    ...
                    <div className="p-4 grid w-full gap-2">
                      ...
                      <button className=" text-white px-3 py-0.5 text-sm rounded-full w-full bg-slate-200 animate-pulse"></button>
                    </div>
                  </div>
                );
              })
